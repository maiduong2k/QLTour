...
public class ThemSuaQuyenForm extends JFrame {
    ...
    public ThemSuaQuyenForm(String _type, String _maq) {
        ...
        if (this.type.equals("Thêm")) {
            ...
            btnSua.setIcon(new ImageIcon(this.getClass().getResource("/giaodienchuan/images/icons8-support-30.png")));
            plButton.add(btnSua);
        }
...
class ChiTietQuyenForm extends JPanel {
    ...
    public ChiTietQuyenForm() {
        ...
        dsPanel.add(new PanelChooseQuyen("Tour", type, new String[]{"xemTour", "qlTour"}));
        dsPanel.add(new PanelChooseQuyen("Loại Tour", type, new String[]{"xemLoaiTour", "qlLoaiTour"}));
        dsPanel.add(new PanelChooseQuyen("Đoàn", type, new String[]{"xemĐoan", "qlĐoan"}));
        ...
        dsPanel.add(new PanelChooseQuyen("Khách sạn", type, new String[]{"xemKS", "qlKS"}));
