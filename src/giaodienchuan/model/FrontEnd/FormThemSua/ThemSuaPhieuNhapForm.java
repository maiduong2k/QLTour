...
public class ThemSuaPhieuNhapForm extends JFrame {
    ...
    JTextField txtMaKS = new JTextField(15);
    ...
    public ThemSuaPhieuNhapForm(String _type, String _mapn) {
        ...
        txtMaKS.setBorder(BorderFactory.createTitledBorder(" "));
        ...
        plChonNhaCungCap.setBorder(BorderFactory.createTitledBorder("Mã khách sạn"));
        plChonNhaCungCap.add(txtMaKS);
        ...
        if (this.type.equals("Thêm")) {
            ...
            txtMaKS.setText(this.pnSua.getMaKS());
    ...
    private void btnThemMouseClicked() {
        if (checkEmpty()) {
            ...
            if (qlpnBUS.add(mapn, maks, manv, ngayNhap, gioNhap, tongTien)) {
    ...
    private void btnSuaMouseClicked() {
        if (checkEmpty()) {
            ...
            if (qlpnBUS.update(mapn, maks, manv, ngayNhap, gioNhap, tongTien)) {
    ...
    private void btnChonNhaCungCapMouseClicked() {
        ChonKhachSanForm cks = new ChonKhachSanForm(txtMaKS);
    }
    ...
    private Boolean checkEmpty() {
        ...
        } else if (maks.trim().equals("")) {
            return showErrorTx(txtMaKS, "Mã phiếu nhập không được để trống");
