...
public class HienThiChiTietPN extends FormHienThi {
    ...
    JComboBox cbTypeSearch = new JComboBox(new String[]{"Tất cả", "Mã phiếu nhập", "Mã tour", "Số lượng", "Đơn giá"});
    ...
    public HienThiChiTietPN(String _mapn) {
        ...
        mtb = new MyTable();
        mtb.setHeaders(new String[]{"STT", "Mã phiếu nhập", "Mã tour", "Tên tour", "Số lượng", "Đơn giá", "Thành tiền"});
    ...
    private void setDataToTable(ArrayList<ChiTietPhieuNhap> data, MyTable mtb) {
        ...
        for (ChiTietPhieuNhap pn : data) {
            mtb.addRow(new String[]{
                ...
                pn.getMa(), 
                pn.getMaT(),
                qltBUS.getTour(pn.getMaT()).getTenT(),
