...
public class HienThiPhieuNhap extends FormHienThi {
    ...
    QuanLyKhachSanBUS qlnccBUS = new QuanLyKhachSanBUS();

    JTextField txTim = new JTextField(10);
    JComboBox cbTypeSearch = new JComboBox(new String[]{"Tất cả", "Mã phiếu nhập", "Mã Khách Sạn", "Mã nhân viên", "Ngày lập", "Giờ lập", "Tổng tiền"});
    
    JTextField txMaPhieuNhap = new JTextField(15);
    JTextField txKSan = new JTextField(15);
    ...
    public HienThiPhieuNhap() {
        ...
        mtb = new MyTable();
        mtb.setPreferredSize(new Dimension(1200 - 250, 500));
        mtb.setHeaders(new String[]{"STT", "Mã phiếu nhập", "Mã khách sạn", "Mã nhân viên", "Ngày nhập", "Giờ nhập", "Tổng tiền"});
        ...
        plThongTin.setPreferredSize(new Dimension(200, 150));
        // set border
        ...
        txKSan.setBorder(BorderFactory.createTitledBorder("Tên khách sạn:"));
        ...
        this.add(plThongTin, BorderLayout.CENTER);
        ...
        if (mapn != null) {
            ...
            for (PhieuNhap pn : qlpn.getDspn()) {
                if (pn.getMaPN().equals(mapn)) {
                    ...
                    String tenncc = qlnccBUS.getKhachSan(pn.getMaKS()).getTenKS();
                    
                    txMaPhieuNhap.setText(pn.getMaPN());
                    txKSan.setText(tenncc + " - " + pn.getMaKS());
