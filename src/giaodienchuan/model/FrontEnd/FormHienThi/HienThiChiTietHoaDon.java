...
public class HienThiChiTietHoaDon extends FormHienThi {
    ...
    JComboBox cbTypeSearch = new JComboBox(new String[]{"Tất cả", "Mã tour", "Số lượng", "Đơn giá"});
    ...
    public HienThiChiTietHoaDon(String _mahd) {
        ...
        mtb = new MyTable();
        mtb.setHeaders(new String[]{"STT", "Mã tour", "Tên tour", "Số lượng", "Đơn giá", "Thành tiền"});
