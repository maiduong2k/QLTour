...
//        plBtn.add(btnSua);
    ...
    private void btnXoaMouseClicked() {
        ...
        if (mat != null) {
            if (JOptionPane.showConfirmDialog(null, "Bạn có chắc muốn xóa tour " + mat + " của phiếu nhập " + this.mapn + "?", "Chú ý", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                new QuanLyChiTietPhieuNhapBUS().delete(this.mapn, mat);
                formHienThi.refresh();
            }
    ...
    private void btnSuaMouseClicked() {
        ...
        ThemSuaChiTietPhieuNhapForm themctpn = new ThemSuaChiTietPhieuNhapForm("Sửa", this.mapn, mat);
