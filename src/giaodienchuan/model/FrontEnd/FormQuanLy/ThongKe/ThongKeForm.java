...
//        tabs.addTab("Thống kê ver2", getIcon("icons8_company_30px.png"), tk2);
        ...
        tabs.addTab("Khách sạn", getIcon("icons8_company_30px.png"), null);
...
class ThongKe_Hoang extends JPanel {
    ...
    public ThongKe_Hoang() {
        ...
        plKSan = getPanelTieuChi("Khách sạn", txKSan, btnChonKSan);
        ...
        tbThongKeHoaDon.setHeaders(new String[]{"Hóa đơn", "Tên nhân viên", "Tên khách hàng", "Tên tour", "Số lượng", "Đơn giá", "Thành tiền"});
        ...
        tbThongKePhieuNhap.setHeaders(new String[]{"Phiếu nhập", "Tên nhân viên", "Tên khách sạn", "Tên tour", "Số lượng", "Đơn giá", "Thành tiền"});
    ...
    private void setDataToPanelTong() {
        ...
        plThongKeSoLuong.add(getJPanelTong("KHÁCH SẠN", "icons8_company_100px.png", qlksBUS.getDsks().size(), Color.BLUE));
    }
    ...
    private void onChangeThongKeBanHang() {
        ...
        ArrayList<Tour> dst = new ArrayList<>(); // lưu các sản phẩm
        ...
        for (HoaDon hd : qlhdBUS.search("Tất cả", "", mcd.getNgayTu(), mcd.getNgayDen(), -1, -1)) {
            ...
            if (dscthd.size() > 0) {
                ...
                for (ChiTietHoaDon cthd : dscthd) {
                    ...
                    if (!dst.contains(t)) {
                        dst.add(t); // thêm vào nếu chưa có
                    }
    ...
    private void onChangeThongKeNhapHang() {
        ...
        ArrayList<KhachSan> dsks = new ArrayList<>(); // danh sách lưu các ks có làm phiếu nhập
        ArrayList<Tour> dst = new ArrayList<>(); // lưu các sản phẩm
        ...
        for (PhieuNhap pn : qlpnBUS.search("Tất cả", "", mcd.getNgayTu(), mcd.getNgayDen(), -1, -1)) {
            ...
            if (dsctpn.size() > 0) {
                ...
                if (!dsks.contains(ks)) {
                    dsks.add(ks); // thêm vào nếu chưa có
                }
