...
public class ChonTourForm extends JFrame {
    ...
    public ChonTourForm(JTextField _masp, JTextField _malsp, JTextField _tensp, JTextField _donGia, JTextField _soLuong, JTextField _matg, JTextField _manxb) {
        ...
        btnOK.addActionListener((ActionEvent ae) -> {
            if (formHienThi.getSelectedRow(1) != null) {
                ...
                if (this.txMatg != null) {
                    this.txMatg.setText(formHienThi.getSelectedRow(6));
                }
                if (this.txManxb != null) {
                    this.txManxb.setText(formHienThi.getSelectedRow(7));
                }
                this.dispose();
            } else {
