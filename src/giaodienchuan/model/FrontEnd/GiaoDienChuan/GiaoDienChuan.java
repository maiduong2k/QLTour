...
import giaodienchuan.model.FrontEnd.FormQuanLy.QuanLyKhachSanForm;
import giaodienchuan.model.FrontEnd.FormQuanLy.QuanLyDoanForm;
import giaodienchuan.model.FrontEnd.FormQuanLy.QuanLyHoaDonForm;
import giaodienchuan.model.FrontEnd.FormQuanLy.QuanLyTourForm;
...
import giaodienchuan.model.FrontEnd.FormQuanLy.QuanLyLoaiTourForm;
...
//    EmptyPage emptypage = new EmptyPage();
    ...
    QuanLyKhachSanForm qlncc;
    QuanLyDoanForm qldoan;
    ThongKeForm thongke;
    ...
    public GiaoDienChuan() {
        ...
        String[] navItemInfo = {
            ...
            "seperate", "2", "", "",
            "Tour", "icons8-book-30.png", "xemTour", "qlTour",
            "Loại Tour", "icons8_dossier_folder_30px.png", "xemLoaiTour", "qlLoaiTour",
            "Đoàn", "icons8_company_30px.png", "xemĐoan", "qlĐoan",
            ...
            "Khách Sạn", "icons8_company_30px.png", "xemKS", "qlKS",
            "seperate", "2", "", "",
        ...
        headerTitle = new NavBarTitle(new Rectangle((WIDTH - 400) / 2, 0, 400, headerH), "QUẢN LÝ TOUR DU LỊCH ");
        ...
        plContent.add(new BeginForm("Chào " + LoginForm.nhanVienLogin.getTenNV() + " - " + LoginForm.nhanVienLogin.getMaNV()), BorderLayout.NORTH);
    ...
    public void doAction(String nameAction) {
        ...
        switch (nameAction) {
            ...
            case "Tour":
                if (qlt == null) {
                    qlt = new QuanLyTourForm();
                }
                plContent.add(qlt, BorderLayout.CENTER);
                break;

            case "Loại Tour":
                if (qllt == null) {
                    qllt = new QuanLyLoaiTourForm();
                }
                plContent.add(qllt, BorderLayout.CENTER);
                break;

            
            case "Đoàn":
                if (qldoan == null){
                    qldoan = new QuanLyDoanForm();
                }
                plContent.add(qldoan, BorderLayout.CENTER);
                break;
