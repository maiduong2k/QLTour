...
//            JOptionPane.showMessageDialog(null, "Khong goi duoc document !");
    ...
    public void writeHoaDon(String mahd) {
        ...
        try {
            ...
            pdfTable.addCell(new PdfPCell(new Phrase("Mã Tour", fontHeader)));
            ...
            for (ChiTietHoaDon cthd : qlcthdBUS.getAllChiTiet(mahd)) {
                ...
                String ma = cthd.getMaTour();
                String ten = qltBUS.getTour(cthd.getMaTour()).getTenT();
    ...
    public void writePhieuNhap(String mapn) {
        ...
        try {
            ...
            Paragraph para1 = new Paragraph();
            para1.setFont(fontData);
            para1.add(String.valueOf("Khách sạn: " + qlnccBUS.getKhachSan(pn.getMaKS()).getTenKS() + "  -  " + pn.getMaKS()));
            para1.add(glue);
...
//            document.add(paraKhuyenMai);
            ...
            for (ChiTietPhieuNhap ctpn : qlctpnBUS.getAllChiTiet(mapn)) {
                pdfTable.addCell(new PdfPCell(new Phrase(ctpn.getMaT(), fontData)));
                pdfTable.addCell(new PdfPCell(new Phrase(qltBUS.getTour(ctpn.getMaT()).getTenT(), fontData)));
